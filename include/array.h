...
// Call in header file where your type's functions are declared.
#define _GENERATE_FUNCTION_PROTOTYPES(type, prefix) \
    typedef struct {                                \
        type* data;                                 \
        int len;                                    \
        int cap;                                    \
...
// Call in source file where your type's functions are implemented.
